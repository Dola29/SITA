            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h3 float-left">Adminstracion de Escuelas</h3>
                    ...
                    <div class="card-body ">
                            ...
                            <div class="col-4 d-flex flex-row-reverse">
                                <div class="input-group col-8 pr-0">
                                    ...
                                    <input type="text"  class="form-control"  
                                        @input="getEscuelas()" v-model="search"
                        ...
                        <b-table class="col-12"
                            ...
                            <template v-slot:cell(accion)="row">
                                ...
                                <b-button size="sm" variant="danger" @click="deleteEscuela(row.item.key_id)" >
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editMode" id="createModalLabel">Crear Escuela</h5>
                        <h5 class="modal-title" v-show="editMode" id="createModalLabel">Actualizar Escuela</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form @submit.prevent="editMode === true ? updateEscuela() : createEscuela()">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="form-group col-9">
                                    ...
                                    <b-form-select v-model="form.facultad_id" :options="facultades"  
...
<script>
    export default {
        ...
        methods:{
            getEscuelas(url = base_url + '/api/escuela/'){
            ...
            updateEscuela(){
                this.$Progress.start();
                this.form.put('api/escuela/'+this.form.key_id)
                .then(()=>{
                    $('#createModal').modal('hide');
                    swal.fire(
                        'Actualizado!',
                        'La Escuela ha sido actializada',
                        'success'
                    );
                    this.$Progress.finish();
                    Fire.$emit('AfterEvent'); 
            ...
            deleteEscuela(key_id){
                swal.fire({
                    ...
                    if (result.value) { 
                        this.form.delete('api/escuela/'+key_id).then(()=>{ 
                            swal.fire(
                                'Eliminado!',
