            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h3 float-left">Adminstracion de Facultades</h3>
                    ...
                    <div class="card-body ">
                            ...
                            <div class="col-4 d-flex flex-row-reverse">
                                <div class="input-group col-8 pr-0">
                                    ...
                                    <input type="text"  class="form-control"  
                                        @input="getFacultades()" v-model="search"
                        ...
                        <b-table class="col-12"
                            ...
                            <template v-slot:cell(accion)="row">
                                ...
                                <b-button size="sm" variant="danger" @click="deleteFacultad(row.item.key_id)" >
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" v-show="!editMode" id="createModalLabel">Crear Facultad</h5>
                        <h5 class="modal-title" v-show="editMode" id="createModalLabel">Actualizar Facultad</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form @submit.prevent="editMode === true ? updateFacultad() : createFacultad()">
...
<script>
    export default {
        ...
        methods:{
            getFacultades(url = base_url + '/api/facultad/'){
            ...
            updateFacultad(){
                this.$Progress.start();
                this.form.put('api/facultad/'+this.form.key_id)
                .then(()=>{
                    $('#createModal').modal('hide');
                    swal.fire(
                        'Actualizado!',
            ...
            deleteFacultad(key_id){
                swal.fire({
                    ...
                    if (result.value) { 
                        this.form.delete('api/facultad/'+key_id).then(()=>{ 
                            swal.fire(
                                'Eliminado!',
